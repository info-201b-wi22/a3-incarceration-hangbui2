...
From my findings, I found that the number of males in prison greatly differ from the number of females in prison. The total amount of males in prison in the most recent date in 2018 is `summary_info$total_m_prison_2018` people, compared to `summary_info$total_f_prison_2018` of females. The year with the highest male in prison is `summary_info$high_m_year` of `summary_info$high_m_value` males. The year with the highest female in prison is `summary_info$high_f_year` of `summary_info$high_f_value` females. The average change (increase) in number of each gender to go to jail is  `summary_info$m_change` for males and `summary_info$f_change` for females.
